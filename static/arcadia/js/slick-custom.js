(function ($) {
    ...
    /*[ Slick4 - Event Slider with Countdown ]
    ===========================================================*/
    ...
    for (var i = 0; i < itemSlick4.length; i++) {
        cap1Slide4[i] = $(itemSlick4[i]).find('.event-title');
        cap2Slide4[i] = $(itemSlick4[i]).find('.event-desc');
        countdownSlide4[i] = $(itemSlick4[i]).find('.countdown'); // countdown element
    }
    ...
    $('.slick4').on('init', function () {
        ...
        action1s4[1] = setTimeout(function () {
            $(cap2Slide4[0]).addClass($(cap2Slide4[0]).data('appear') + ' visible-true');
        }, 1000);

        startCountdown(countdownSlide4[0]);
    });
    ...
    $('.slick4').on('afterChange', function (event, slick, currentSlide) {
        ...
        startCountdown(countdownSlide4[currentSlide]);
    });

    function startCountdown($el) {
        var target = new Date($el.data('datetime')).getTime();
